# Rust Spec → Implemented Map

This checklist maps the current Rust baseline to project specs.
...
- ⚠️ Rust-specific benchmark runner wiring not added yet

## Next Minimal Milestones

1. Wire Rust binary into cross-language benchmark orchestrator.
2. Add Rust test coverage (smoke + deterministic behavior checks).
3. Keep output snapshots in parity checks against Python/C++ behavior.
