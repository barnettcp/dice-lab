# Java Spec → Implemented Map

This checklist maps the current Java baseline to project specs.
...
- ⚠️ Java wiring in benchmark runner intentionally deferred to a separate commit

## Next Minimal Milestones

1. Add Java binary invocation path to benchmark runner when ready.
2. Add Java unit tests for deterministic seed behavior and output ordering.
3. Add a package/distribution strategy (`jar` or wrapper script) for easier CLI invocation.
